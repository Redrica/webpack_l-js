...
**/
    ...
    output: {
        ...
        filename: '[name]', // задается шаблон, вместо name будет подставлено ИМЯ ТОЧКИ ВХОДА, соответствующей файлу, а не самого файла, на основе которого собирается бандл.
